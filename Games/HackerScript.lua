...
PluginsHint.Text = "Download plugins from the Hacker#3331 Discord (Coming Soon)"
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		inviteButton.Text = "Copy Discord Invite Link (Coming Soon)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if toClipboard then
		...
		notify('Discord Invite', 'Coming Soon')
	end
	if httprequest then
		httprequest({
