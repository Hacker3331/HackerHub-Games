...
local v44 = v0:CreateWindow({Title=("Hacker Hub | Breaking Point | Welcome : " .. game.Players.LocalPlayer.DisplayName),Center=true,AutoShow=true,TabPadding=5,MenuFadeTime=(0.2 + 0)});
local v45 = {Main=v44:AddTab("Main")};
local v46 = v45.Main:AddLeftGroupbox("[>LocalPlayer<]");
game:GetService("RunService").RenderStepped:Connect(function()
	pcall(function()
		if _G.speedkuys then
			game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = _G.SelectBoost;
		end
	end);
end);
game:GetService("RunService").RenderStepped:Connect(function()
...
game:GetService("RunService").RenderStepped:Connect(function()
	pcall(function()
		if _G.FieldOfView then
			game:GetService("Workspace").Camera.FieldOfView = _G.FieldOfView;
		end
	end);
end);
v46:AddSlider("MySliderspeed", {Text=">Speed Boots< ",Default=6.5,Min=(0 - 0),Max=6.5,Rounding=1,Compact=true,Callback=function(Value)
	_G.SelectBoost = Value
end})
v46:AddSlider("MySliderspeed", {Text=">Speed Boots< ",Default=120,Min=(1226 - (1074 + 82)),Max=120,Rounding=1,Compact=true,Callback=function(Value)
...
v46:AddToggle("MyToggle", {Text="Noclip",Default=false,Tooltip="Noclip No Bypass",Callback=function(Value)
	local v87 = 0 + 0;
	while true do
		if (v87 == 0) then
			getgenv().col = Value;
...
v46:AddToggle("MyToggle", {Text="Night Vision",Default=false,Tooltip="See On Dark",Callback=function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Hacker3331/Hacker3331/main/NightVision.lua"))()
end})
v46:AddToggle("MyToggle", {Text="Big Hit Box",Default=false,Tooltip="Aim People Easy",Callback=function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Hacker3331/Hacker3331/main/BigHitBox.lua"))()
end})
v46:AddToggle("MyToggle", {Text="Kill Aura",Default=false,Tooltip="Kill Aura",Callback=function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Hacker3331/Hacker3331/main/KillAura.lua"))()
end})
v46:AddToggle("MyToggle", {Text="ESP Player",Default=false,Tooltip="See all player location",Callback=function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/Hacker3331/Hacker3331/main/ESP-Player.lua"))()
end})
local v54 = v46:AddButton({Text="Aimbot",Func=function()
game:GetService("StarterGui"):SetCore("SendNotification",{
		Title = "Hacker Notification", -- Required
		Text = "Credit : asgar3199", -- Required
		Icon = "rbxassetid://1234567890" -- Optional
})
loadstring(game:HttpGet("https://pastebin.com/7c8Bw0ve"))()
end,DoubleClick=false,Tooltip="The Script Work For Shot/Throw Knife Easy"});
...
local v58 = game:GetService("RunService").RenderStepped:Connect(function()
	...
	while true do
		...
		if (v223 == (680 - (642 + 37))) then
			v0:SetWatermark(("Hacker Hub | Breaking Point | %s fps | %s ms"):format(math.floor(v57),math.floor(game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValue())))
		end
	end
end)